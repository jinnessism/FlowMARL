...
from envs.wrapped_environments.base import ResetReturn, StepReturn, BaseEnvironment
from envs.wrapped_environments.wrappers import Dtype, PadObsandActs
...
def get_env_config(scenario: str) -> Dict[str, Any]:
    ...
    if scenario.lower() == "halfcheetah":
        ...
        env_args["local_categories"] = [["qpos", "qvel"], ["qpos"]]
